pipeline {
    ...
    environment {
        DOCKER_HUB_REPO = 'snirala1995/api_gateways'
        DOCKER_IMAGE_TAG = "${DOCKER_HUB_REPO}:${env.BUILD_NUMBER}"
        CONTAINER_NAME = 'api_gateways' // Name for your Docker container
        CONTAINER_PORT = '9094' // Port inside the Docker container
